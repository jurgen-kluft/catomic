...
namespace xcore
{
	namespace cpu
	{
		...
		namespace cpu_info_sys
		{
			...
			enum Manufacturer 
			{
				AMD, Intel, NSC, UMC, Cyrix, NexGen, IDT, Rise, Transmeta, Sony, IBM, ARM, UnknownManufacturer
			};
			...
			static void sInitialize()
			{
				...
				x_strcpy(ChipID.ProcessorName, sizeof(ChipID.ProcessorName), "ARM11 MPCore");
				x_strcpy(ChipID.Vendor, sizeof(ChipID.Vendor), "ARM");
				...
				Features.CPUSpeed = 268;
				Features.L1CacheSize = 32 * 1024;
		...
		static u64 sCPUSpeedInkHz = 268 * 1000; 
