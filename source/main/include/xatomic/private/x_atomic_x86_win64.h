...
namespace xcore
{
	...
	{
		/**
		 * 32 and 64 bit interlocked compare and exchange functions for a 64 bit cpu
		 */
		namespace cpu_x86_64
		{
			...
			{
				u32 old = ::InterlockedCompareExchange(dest, exchange, comperand);
			...
			{
				return ::InterlockedCompareExchange64((LONGLONG volatile*)dest, exchange, comperand);
			}
			...
			{
				u64 old = ::InterlockedCompareExchange(dest, exchange, comperand);
				return old == comperand;
		...
		namespace cpu_interlocked = cpu_x86_64;
