...
namespace xcore
{
	...
	namespace atomic
	{
		...
		#include "catomic/private/c_atomic_x86_win32.h"
	#else
		#include "catomic/private/c_atomic_x86_win64.h"
	#endif
#elif defined(TARGET_360)
	#include "catomic/private/c_atomic_ppc_360.h"
#elif defined(TARGET_PS3)
	#include "catomic/private/c_atomic_ppc_ps3.h"
#elif defined(TARGET_WII)
	#include "catomic/private/c_atomic_ppc_wii.h"
#elif defined(TARGET_3DS)
	#include "catomic/private/c_atomic_arm_3ds.h"
#else
